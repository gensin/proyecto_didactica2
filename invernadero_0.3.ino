...
void apagar_bombilla_calentadora(){
  ...
  digitalWrite(BOMBILLA_CALOR, HIGH); //Apagado de la bombilla para calentar
}
...
//BUCLE PRINCIPAL ==================================================================================
void loop() {
  // Mejora propuesta: leer cuando nos indiquen los temporizadores definidos en el apartado "FRECUENCIAS DE MUESTREO"
